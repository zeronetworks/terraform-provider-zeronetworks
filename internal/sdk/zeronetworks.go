...
var ServerList = []string{
	// Customer URL
	"https://portal.zeronetworks.com/v1/api",
}
...
// ZeroNetworks - Zero Networks: APIs for Zero Networks
type ZeroNetworks struct {
	SDKVersion string
...
type SDKOption func(*ZeroNetworks)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *ZeroNetworks) {
...
// WithCustomerURL allows setting the CustomerURL variable for url substitution
func WithCustomerURL(customerURL string) SDKOption {
	return func(sdk *ZeroNetworks) {
		for idx := range sdk.sdkConfiguration.ServerVariables {
			if _, ok := sdk.sdkConfiguration.ServerVariables[idx]["CustomerURL"]; !ok {
				continue
			}

			sdk.sdkConfiguration.ServerVariables[idx]["CustomerURL"] = fmt.Sprintf("%v", customerURL)
		}
	}
}
