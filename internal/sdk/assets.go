...
// Assets - API calls related to Assets.
type Assets struct {
...
func newAssets(rootSDK *ZeroNetworks, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Assets {
	return &Assets{
		rootSDK:          rootSDK,
...
// AssetsSearch - Search Asset by FQDN
// Returns an assetId.
func (s *Assets) AssetsSearch(ctx context.Context, request operations.AssetsSearchRequest, opts ...operations.Option) (*operations.AssetsSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/assets/searchId")
	if err != nil {
	...
	res := &operations.AssetsSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AssetIDSearch
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AssetIDSearch = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
