...
func newCustomGroup(rootSDK *ZeroNetworks, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CustomGroup {
	return &CustomGroup{
		rootSDK:          rootSDK,
...
// CustomGroupGet - Get a custom group
// Returns the properties of an custom group.
func (s *CustomGroup) CustomGroupGet(ctx context.Context, request operations.CustomGroupGetRequest, opts ...operations.Option) (*operations.CustomGroupGetResponse, error) {
