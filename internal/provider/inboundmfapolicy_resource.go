...
var _ resource.Resource = &InboundMFAPolicyResource{}
var _ resource.ResourceWithImportState = &InboundMFAPolicyResource{}

func NewInboundMFAPolicyResource() resource.Resource {
	return &InboundMFAPolicyResource{}
}
...
// InboundMFAPolicyResourceModel describes the resource data model.
type InboundMFAPolicyResourceModel struct {
	...
	DstEntityInfo                  tfTypes.ReactivePolicyInboundBodyDstEntityInfo `tfsdk:"dst_entity_info"`
	DstPort                        types.String                                   `tfsdk:"dst_port"`
	DstProcessNames                []types.String                                 `tfsdk:"dst_process_names"`
	EnforcementSource              types.Int32                                    `tfsdk:"enforcement_source"`
	ExcludedSrcEntityInfos         []tfTypes.IDNamePair                           `tfsdk:"excluded_src_entity_infos"`
	...
	ProtocolType                   types.Int64                                    `tfsdk:"protocol_type"`
	...
	SrcEntityInfos                 []tfTypes.IDNamePair                           `tfsdk:"src_entity_infos"`
	SrcProcessNames                []types.String                                 `tfsdk:"src_process_names"`
	SrcUserInfos                   []tfTypes.IDNamePair                           `tfsdk:"src_user_infos"`
...
func (r *InboundMFAPolicyResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_inbound_mfa_policy"
}

func (r *InboundMFAPolicyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "InboundMFAPolicy Resource",
		Attributes: map[string]schema.Attribute{
			...
			"protocol_type": schema.Int64Attribute{
				Required: true,
			},
...
func (r *InboundMFAPolicyResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *InboundMFAPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *InboundMFAPolicyResourceModel
	...
	request, requestDiags := data.ToSharedReactivePolicyInboundBody(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAInbound.MFAInboundPoliciesCreate(ctx, *request)
	if err != nil {
...
func (r *InboundMFAPolicyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *InboundMFAPolicyResourceModel
	...
	request, requestDiags := data.ToOperationsMFAInboundPoliciesGetRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAInbound.MFAInboundPoliciesGet(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundMFAPolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *InboundMFAPolicyResourceModel
	var plan types.Object
	...
	request, requestDiags := data.ToOperationsMFAInboundPoliciesUpdateRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAInbound.MFAInboundPoliciesUpdate(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundMFAPolicyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *InboundMFAPolicyResourceModel
	var item types.Object
	...
	request, requestDiags := data.ToOperationsMFAInboundPoliciesDeleteRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAInbound.MFAInboundPoliciesDelete(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundMFAPolicyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
