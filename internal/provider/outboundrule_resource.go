...
var _ resource.Resource = &OutboundRuleResource{}
var _ resource.ResourceWithImportState = &OutboundRuleResource{}

func NewOutboundRuleResource() resource.Resource {
	return &OutboundRuleResource{}
}

// OutboundRuleResource defines the resource implementation.
type OutboundRuleResource struct {
	// Provider configured SDK client.
	client *sdk.ZeroNetworks
}

// OutboundRuleResourceModel describes the resource data model.
type OutboundRuleResourceModel struct {
...
func (r *OutboundRuleResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_outbound_rule"
}

func (r *OutboundRuleResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "OutboundRule Resource",
...
func (r *OutboundRuleResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *OutboundRuleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *OutboundRuleResourceModel
	...
	request, requestDiags := data.ToSharedRuleBody(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesOutbound.OutboundRulesCreate(ctx, *request)
	if err != nil {
	...
	request1, request1Diags := data.ToOperationsOutboundRuleGetRequest(ctx)
	resp.Diagnostics.Append(request1Diags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res1, err := r.client.RulesOutbound.OutboundRuleGet(ctx, *request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
...
func (r *OutboundRuleResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *OutboundRuleResourceModel
...
func (r *OutboundRuleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *OutboundRuleResourceModel
	var plan types.Object
	...
	request, requestDiags := data.ToOperationsOutboundRuleUpdateRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesOutbound.OutboundRuleUpdate(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *OutboundRuleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *OutboundRuleResourceModel
	var item types.Object
	...
	request, requestDiags := data.ToOperationsOutboundRuleDeleteRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesOutbound.OutboundRuleDelete(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *OutboundRuleResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
