...
var _ datasource.DataSource = &InboundRuleDataSource{}
var _ datasource.DataSourceWithConfigure = &InboundRuleDataSource{}

func NewInboundRuleDataSource() datasource.DataSource {
	return &InboundRuleDataSource{}
}
...
// InboundRuleDataSourceModel describes the data model.
type InboundRuleDataSourceModel struct {
...
func (r *InboundRuleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_inbound_rule"
}

// Schema defines the schema for the data source.
func (r *InboundRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "InboundRule DataSource",
...
func (r *InboundRuleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *InboundRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *InboundRuleDataSourceModel
