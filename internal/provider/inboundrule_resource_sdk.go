...
func (r *InboundRuleResourceModel) RefreshFromSharedRule(ctx context.Context, resp *shared.Rule) diag.Diagnostics {
...
func (r *InboundRuleResourceModel) ToOperationsInboundRuleDeleteRequest(ctx context.Context) (*operations.InboundRuleDeleteRequest, diag.Diagnostics) {
	...
	out := operations.InboundRuleDeleteRequest{
		ID: id,
	}
...
func (r *InboundRuleResourceModel) ToOperationsInboundRuleGetRequest(ctx context.Context) (*operations.InboundRuleGetRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *InboundRuleResourceModel) ToOperationsInboundRuleUpdateRequest(ctx context.Context) (*operations.InboundRuleUpdateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.InboundRuleUpdateRequest{
		ID:       id,
		RuleBody: *ruleBody,
	}
...
func (r *InboundRuleResourceModel) ToSharedRuleBody(ctx context.Context) (*shared.RuleBody, diag.Diagnostics) {
	var diags diag.Diagnostics
