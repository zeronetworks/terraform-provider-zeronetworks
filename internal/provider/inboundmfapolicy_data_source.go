...
var _ datasource.DataSource = &InboundMFAPolicyDataSource{}
var _ datasource.DataSourceWithConfigure = &InboundMFAPolicyDataSource{}

func NewInboundMFAPolicyDataSource() datasource.DataSource {
	return &InboundMFAPolicyDataSource{}
}
...
// InboundMFAPolicyDataSourceModel describes the data model.
type InboundMFAPolicyDataSourceModel struct {
...
func (r *InboundMFAPolicyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_inbound_mfa_policy"
}

// Schema defines the schema for the data source.
func (r *InboundMFAPolicyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "InboundMFAPolicy DataSource",
...
func (r *InboundMFAPolicyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *InboundMFAPolicyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *InboundMFAPolicyDataSourceModel
