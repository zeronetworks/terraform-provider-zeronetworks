...
var _ resource.Resource = &InboundRuleResource{}
var _ resource.ResourceWithImportState = &InboundRuleResource{}

func NewInboundRuleResource() resource.Resource {
	return &InboundRuleResource{}
}
...
// InboundRuleResourceModel describes the resource data model.
type InboundRuleResourceModel struct {
...
func (r *InboundRuleResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_inbound_rule"
}

func (r *InboundRuleResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "InboundRule Resource",
...
func (r *InboundRuleResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *InboundRuleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *InboundRuleResourceModel
	...
	res, err := r.client.RulesInbound.InboundRulesCreate(ctx, *request)
	if err != nil {
...
func (r *InboundRuleResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *InboundRuleResourceModel
	...
	request, requestDiags := data.ToOperationsInboundRuleGetRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesInbound.InboundRuleGet(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundRuleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *InboundRuleResourceModel
	var plan types.Object
	...
	request, requestDiags := data.ToOperationsInboundRuleUpdateRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesInbound.InboundRuleUpdate(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundRuleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *InboundRuleResourceModel
	var item types.Object
	...
	request, requestDiags := data.ToOperationsInboundRuleDeleteRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.RulesInbound.InboundRuleDelete(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *InboundRuleResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
