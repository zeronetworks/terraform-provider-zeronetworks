...
func (r *OutboundMFAPolicyResourceModel) RefreshFromSharedReactivePolicyItem(ctx context.Context, resp *shared.ReactivePolicyItem) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *OutboundMFAPolicyResourceModel) RefreshFromSharedReactivePolicyResponse(ctx context.Context, resp *shared.ReactivePolicyResponse) diag.Diagnostics {
	var diags diag.Diagnostics
