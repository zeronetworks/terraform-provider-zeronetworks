...
var _ resource.Resource = &OutboundMFAPolicyResource{}
var _ resource.ResourceWithImportState = &OutboundMFAPolicyResource{}

func NewOutboundMFAPolicyResource() resource.Resource {
	return &OutboundMFAPolicyResource{}
}

// OutboundMFAPolicyResource defines the resource implementation.
type OutboundMFAPolicyResource struct {
	// Provider configured SDK client.
	client *sdk.ZeroNetworks
}

// OutboundMFAPolicyResourceModel describes the resource data model.
type OutboundMFAPolicyResourceModel struct {
	...
	DstEntityInfo                  tfTypes.ReactivePolicyOutboundBodyDstEntityInfo `tfsdk:"dst_entity_info"`
...
func (r *OutboundMFAPolicyResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_outbound_mfa_policy"
}

func (r *OutboundMFAPolicyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "OutboundMFAPolicy Resource",
...
func (r *OutboundMFAPolicyResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *OutboundMFAPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *OutboundMFAPolicyResourceModel
	...
	request, requestDiags := data.ToSharedReactivePolicyOutboundBody(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAOutbound.MFAOutboundPoliciesCreate(ctx, *request)
	if err != nil {
...
func (r *OutboundMFAPolicyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *OutboundMFAPolicyResourceModel
...
func (r *OutboundMFAPolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *OutboundMFAPolicyResourceModel
	var plan types.Object
	...
	request, requestDiags := data.ToOperationsMFAOutboundPoliciesUpdateRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAOutbound.MFAOutboundPoliciesUpdate(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *OutboundMFAPolicyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *OutboundMFAPolicyResourceModel
	var item types.Object
	...
	request, requestDiags := data.ToOperationsMFAOutboundPoliciesDeleteRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MFAOutbound.MFAOutboundPoliciesDelete(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *OutboundMFAPolicyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
